...
class opts(object):
  def __init__(self,current_dir,model_path,input_path,threshold,use_gpu):
    ...
    # system
    self.parser.add_argument('--gpus', default=self.use_gpu,
    ...
    self.parser.add_argument('--output-root', type=str, default=current_dir + '/output_result', help='expected output root path')
